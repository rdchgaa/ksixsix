...
/// [RefreshLoadingIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [RefreshLoadingIndicator.onRefresh].
...
/// Used to configure how [RefreshLoadingIndicator] can be triggered.
...
///
/// The trigger mode is configured by [RefreshLoadingIndicator.triggerMode].
///
/// ## Troubleshooting
///
/// ### Refresh indicator does not show up
///
/// The [RefreshLoadingIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [RefreshLoadingIndicator] will always appear, even if the
...
/// ```
///
/// A [RefreshLoadingIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [RefreshLoadingIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [RefreshLoadingIndicator] to show
///    the inner circular progress spinner during refreshes.
///  * [CupertinoSliverRefreshControl], an iOS equivalent of the pull-to-refresh pattern.
///    Must be used as a sliver inside a [CustomScrollView] instead of wrapping
///    around a [ScrollView] because it's a part of the scrollable instead of
///    being overlaid on top of it.
class RefreshLoadingIndicator extends StatefulWidget {
  ...
  /// Defines how this [RefreshLoadingIndicator] can be triggered when users overscroll.
  ///
  /// The [RefreshLoadingIndicator] can be pulled out in two cases,
  ...
  @override
  RefreshLoadingIndicatorState createState() => RefreshLoadingIndicatorState();
}

/// Contains the state for a [RefreshLoadingIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class RefreshLoadingIndicatorState extends State<RefreshLoadingIndicator> with TickerProviderStateMixin<RefreshLoadingIndicator> {
  ...
  @override
  void didUpdateWidget(covariant RefreshLoadingIndicator oldWidget) {
  ...
  bool _handleGlowNotification(OverscrollNotification notification) {
    if (widget.notificationPredicate(notification) && notification.overscroll > 0) {
      _onLoading();
      return false;
    }
    return false;
      ...
      if (refreshResult == null) {
        FlutterError.reportError(FlutterErrorDetails(
          exception: FlutterError('The onRefresh callback returned null.\n'
              'The RefreshLoadingIndicator onRefresh callback must return a Future.'),
  ...
  ///
  /// Creating the [RefreshLoadingIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [RefreshLoadingIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [RefreshLoadingIndicator.onRefresh] callback's future completes.
  ///
