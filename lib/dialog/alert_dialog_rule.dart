                        ...
                        child: DecoratedBox(
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              ...
                              colors: [Color(0xff51079c), Color(0xff022A15)],
                            ),
                                  ...
                                  child: ListView(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text('牌的大小',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5.0),
                                        child: Text('按照其点数大小排列，A为最低点数，而K为最高点数。 JQK都等于10。',style: TextStyle(fontSize: 12,color: Color(0xffcccccc)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 10.0),
                                        child: Text('牌型比较',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5.0),
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(top: 10.0),
                                        child: Text('牌型分类',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5.0),
                                        child: Text('无牛：三张牌中没有组合成10的倍数。'
                                            ...
                                            '\n金牛：五张十以上的花牌组成的“斗牛”。'
                                            '\n五小：5张牌牌点总数小于或者等于10。'
                                            '\n炸弹：四张牌点一样的牌。',style: TextStyle(fontSize: 12,color: Color(0xffcccccc)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 10.0),
                                        child: Text('比牌',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5.0),
                                        child: Text('优先对比牌型，牌型一样比单牌大小，牌一样比花色。'
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(top: 10.0),
                                        child: Text('赔率',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(top: 10.0),
                                        child: Text('游戏轮次',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5.0,bottom: 10),
                                        child: Text('10回合为1局，每回合结果立即显示结果，10回合后显示当局总结果。首页对局记录显示每局记录',style: TextStyle(fontSize: 12,color: Color(0xffcccccc)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 10.0),
                                        child: Text('其他',style: TextStyle(fontSize: 14,color: Color(0xffedd577)),),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(top: 5.0,bottom: 10),
                                        child: Text('默认投注1',style: TextStyle(fontSize: 12,color: Color(0xffcccccc)),),
                                      ),
